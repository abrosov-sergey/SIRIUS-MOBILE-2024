...
/// @nodoc
mixin _$MapState {
  bool get showRoute => throw _privateConstructorUsedError;
...
class _$MapStateCopyWithImpl<$Res, $Val extends MapState>
  ...
  @override
  $Res call({
    Object? showRoute = null,
  }) {
    return _then(_value.copyWith(
      showRoute: null == showRoute
          ? _value.showRoute
          : showRoute // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$MapStateImpl implements _MapState {
  const _$MapStateImpl({required this.showRoute});
  ...
  @override
  String toString() {
    return 'MapState(showRoute: $showRoute)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.showRoute, showRoute) ||
                other.showRoute == showRoute));
  }

  @override
  int get hashCode => Object.hash(runtimeType, showRoute);
...
abstract class _MapState implements MapState {
  const factory _MapState({required final bool showRoute}) = _$MapStateImpl;
