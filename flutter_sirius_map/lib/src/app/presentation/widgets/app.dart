...
import 'package:flutter_sirius_map/src/features/qr_scanner/presentation/pages/qr_scanner_page.dart';
    ...
    return ScreenUtilInit(
      ...
      child: MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          AppRoutes.qrRoot: (BuildContext context) => const QrScannerPage(),
        },
      ),
    );
  }
